    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // opening new activity and revewing
                if (itemsInCartList!=null && itemsInCartList.size()<=0){
                    Toast.makeText(RestaurentMenuActivity.this, "Please add some items to checkout !", Toast.LENGTH_SHORT).show();
                    return;
                }
                restaurentModel.setMenus(itemsInCartList);
                Intent i = new Intent(RestaurentMenuActivity.this,PlaceYourOrderActivity.class);
                i.putExtra("RestaurentModel",restaurentModel);
